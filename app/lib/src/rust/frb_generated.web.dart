...
abstract class RustLibApiImplPlatform extends BaseApiImpl<RustLibWire> {
  ...
  List<dynamic> cst_encode_ui_layout_value(UILayoutValue raw) {
    ...
    if (raw is UILayoutValue_ShowsRecommendation) {
      return [1, cst_encode_bool(raw.field0)];
    }
    if (raw is UILayoutValue_SidebarPreivew) {
      return [2, cst_encode_bool(raw.field0)];
    }
