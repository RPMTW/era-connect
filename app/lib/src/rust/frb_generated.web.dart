...
abstract class RustLibApiImplPlatform extends BaseApiImpl<RustLibWire> {
  ...
  @protected
  List<dynamic> cst_encode_list_record_collection_id_progress(
      List<(CollectionId, Progress)> raw) {
    return raw.map(cst_encode_record_collection_id_progress).toList();
  }
  ...
  List<dynamic> cst_encode_progress(Progress raw) {
    return [
      cst_encode_f_64(raw.speed),
      cst_encode_f_64(raw.percentages),
      cst_encode_f_64(raw.currentSize),
      cst_encode_f_64(raw.totalSize)
    ];
  }

  @protected
  List<dynamic> cst_encode_record_collection_id_progress(
      (CollectionId, Progress) raw) {
    return [cst_encode_collection_id(raw.$1), cst_encode_progress(raw.$2)];
  }
...
class RustLibWire extends BaseWire {
  ...
  void wire_DownloadProgress_get_p(NativePortType port_, Object that) =>
      wasmModule.wire_DownloadProgress_get_p(port_, that);
  ...
  void wire_get_v(NativePortType port_) => wasmModule.wire_get_v(port_);
  ...
  void rust_arc_increment_strong_count_RustOpaque_stdsyncRwLockcrateapiDownloadProgress(
          dynamic ptr) =>
      wasmModule
          .rust_arc_increment_strong_count_RustOpaque_stdsyncRwLockcrateapiDownloadProgress(
              ptr);

  void rust_arc_decrement_strong_count_RustOpaque_stdsyncRwLockcrateapiDownloadProgress(
          dynamic ptr) =>
      wasmModule
          .rust_arc_decrement_strong_count_RustOpaque_stdsyncRwLockcrateapiDownloadProgress(
              ptr);
...
class RustLibWasmModule implements WasmModule {
  ...
  external void wire_DownloadProgress_get_p(NativePortType port_, Object that);
  ...
  external void wire_get_v(NativePortType port_);
