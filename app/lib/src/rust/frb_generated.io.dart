...
abstract class RustLibApiImplPlatform extends BaseApiImpl<RustLibWire> {
  ...
  @protected
  ffi.Pointer<wire_cst_list_storage_loader> cst_encode_list_storage_loader(
      List<StorageLoader> raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    final ans = wire.cst_new_list_storage_loader(raw.length);
    for (var i = 0; i < raw.length; ++i) {
      cst_api_fill_to_wire_storage_loader(raw[i], ans.ref.ptr[i]);
    }
    return ans;
  }
  ...
  @protected
  void cst_api_fill_to_wire_storage_loader(
      StorageLoader apiObj, wire_cst_storage_loader wireObj) {
...
class RustLibWire implements BaseWire {
  ...
  ffi.Pointer<wire_cst_list_storage_loader> cst_new_list_storage_loader(
    int len,
  ) {
    return _cst_new_list_storage_loader(
      len,
    );
  }

  late final _cst_new_list_storage_loaderPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<wire_cst_list_storage_loader> Function(
              ffi.Int32)>>('frbgen_era_connect_cst_new_list_storage_loader');
  late final _cst_new_list_storage_loader = _cst_new_list_storage_loaderPtr
      .asFunction<ffi.Pointer<wire_cst_list_storage_loader> Function(int)>();
...
final class wire_cst_storage_loader extends ffi.Struct {
  external ffi.Pointer<wire_cst_list_prim_u_8_strict> file_name;

  @ffi.UintPtr()
  external int base_path;
}

final class wire_cst_list_storage_loader extends ffi.Struct {
  external ffi.Pointer<wire_cst_storage_loader> ptr;
