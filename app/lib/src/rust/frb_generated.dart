...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<List<StorageLoader>> collectionScan({dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      codec: DcoCodec(
        decodeSuccessData: dco_decode_list_storage_loader,
        decodeErrorData: dco_decode_AnyhowException,
      ),
  ...
  List<StorageLoader> dco_decode_list_storage_loader(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_storage_loader).toList();
  }
  ...
  List<StorageLoader> sse_decode_list_storage_loader(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <StorageLoader>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_storage_loader(deserializer));
    }
    return ans_;
  }
  ...
  StorageLoader sse_decode_storage_loader(SseDeserializer deserializer) {
    ...
    var var_basePath =
        sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedrust_asyncRwLockPathBuf(
            deserializer);
    return StorageLoader(fileName: var_fileName, basePath: var_basePath);
  }
...
// ignore: invalid_use_of_internal_member
  ...
  void sse_encode_list_storage_loader(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_storage_loader(item, serializer);
    }
  }
