...
// The type `MinecraftTokenResponse` is not used by any `pub` functions, thus it is ignored.
// The type `MinecraftUserProfile` is not used by any `pub` functions, thus it is ignored.
// The type `XboxLiveDisplayClaims` is not used by any `pub` functions, thus it is ignored.
// The type `XboxLiveDisplayClaimsXui` is not used by any `pub` functions, thus it is ignored.
// The type `XboxLiveResponse` is not used by any `pub` functions, thus it is ignored.
// The type `XstsResponse` is not used by any `pub` functions, thus it is ignored.
// The type `XstsTokenError` is not used by any `pub` functions, thus it is ignored.
