...
FlutterRustBridgeTaskConstMeta get kGetLoggerConstMeta;
...
FlutterRustBridgeTaskConstMeta get kSetUiLayoutConfigConstMeta;
    ...
    OpaqueTypeFinalizer get PathBufFinalizer;
        ...
        @sealed class PathBuf extends FrbOpaque {
                final Native bridge;
...
final String versionType;
                    ...
                    const GameOptions({required this.authPlayerName ,required this.gameVersionName ,required this.gameDirectory ,required this.assetsRoot ,required this.assetsIndexName ,required this.authUuid ,required this.userType ,required this.versionType ,});
...
final PathBuf nativeDirectory;
                    ...
                    const JvmOptions({required this.launcherName ,required this.launcherVersion ,required this.classpath ,required this.classpathSeparator ,required this.primaryJar ,required this.libraryDirectory ,required this.gameDirectory ,required this.nativeDirectory ,});
...
final List<String> gameArgs;
                    ...
                    const LaunchArgs({required this.jvmArgs ,required this.mainClass ,required this.gameArgs ,});
...
final int timeMillis;
                    ...
                    const LogEntry({required this.level ,required this.message ,required this.timeMillis ,});
...
final GameOptions gameArgs;
                    ...
                    const PrepareGameArgs({required this.launchArgs ,required this.jvmArgs ,required this.gameArgs ,});
...
final double totalSize;
                    ...
                    const Progress({required this.speed ,required this.percentages ,required this.currentSize ,required this.totalSize ,});
...
final PrepareGameArgs? prepareNameArgs;
                    ...
                    const ReturnType({this.progress ,this.prepareNameArgs ,});
...
class UILayout with _$UILayout {
                    ...
                    const factory UILayout({ required  bool completedSetup,}) = _UILayout;
