...
Stream<LogEntry> getLogger({ dynamic hint }) {
            
            return _platform.executeStream(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_get_logger(port_),
            parseSuccessData: _wire2api_log_entry,
            
        constMeta: kGetLoggerConstMeta,
        argValues: [],
        hint: hint,
        ...
        FlutterRustBridgeTaskConstMeta get kGetLoggerConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "get_logger",
            argNames: [],
        );
...
Stream<ReturnType> downloadVanilla({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kDownloadVanillaConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "download_vanilla",
            argNames: [],
        );
        
Future<void> launchGame({ required PrepareGameArgs preLaunchArguments ,dynamic hint }) {
            var arg0 = _platform.api2wire_box_autoadd_prepare_game_args(preLaunchArguments);
        ...
        FlutterRustBridgeTaskConstMeta get kLaunchGameConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "launch_game",
            argNames: ["preLaunchArguments"],
        );
        
Stream<ReturnType> downloadQuilt({ required PrepareGameArgs quiltPrepare ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kDownloadQuiltConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<DownloadState> fetchState({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kFetchStateConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> writeState({ required DownloadState s ,dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kWriteStateConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<UILayout> getUiLayoutConfig({ dynamic hint }) {
        ...
        FlutterRustBridgeTaskConstMeta get kGetUiLayoutConfigConstMeta => const FlutterRustBridgeTaskConstMeta(
...
Future<void> setUiLayoutConfig({ required UILayout config ,dynamic hint }) {
            ...
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_set_ui_layout_config(port_, arg0),
            parseSuccessData: _wire2api_unit,
        ...
        FlutterRustBridgeTaskConstMeta get kSetUiLayoutConfigConstMeta => const FlutterRustBridgeTaskConstMeta(
...
GameOptions _wire2api_game_options(dynamic raw) {
            ...
            return GameOptions(authPlayerName: _wire2api_String(arr[0]),
...
JvmOptions _wire2api_jvm_options(dynamic raw) {
            final arr = raw as List<dynamic>;
            if (arr.length != 8) throw Exception('unexpected arr length: expect 8 but see ${arr.length}');
            return JvmOptions(launcherName: _wire2api_String(arr[0]),
...
LaunchArgs _wire2api_launch_args(dynamic raw) {
            ...
            return LaunchArgs(jvmArgs: _wire2api_StringList(arr[0]),
...
LogEntry _wire2api_log_entry(dynamic raw) {
            final arr = raw as List<dynamic>;
            if (arr.length != 3) throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
            return LogEntry(level: _wire2api_log_level(arr[0]),
message: _wire2api_String(arr[1]),
timeMillis: _wire2api_i64(arr[2]),);
        }
...
PrepareGameArgs _wire2api_prepare_game_args(dynamic raw) {
            final arr = raw as List<dynamic>;
            if (arr.length != 3) throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
            return PrepareGameArgs(launchArgs: _wire2api_launch_args(arr[0]),
...
Progress _wire2api_progress(dynamic raw) {
            ...
            return Progress(speed: _wire2api_f64(arr[0]),
...
ReturnType _wire2api_return_type(dynamic raw) {
            ...
            return ReturnType(progress: _wire2api_opt_box_autoadd_progress(arr[0]),
...
UILayout _wire2api_ui_layout(dynamic raw) {
            ...
            return UILayout(completedSetup: _wire2api_bool(arr[0]),);
        }
...
@protected
                    ffi.Pointer<wire_PrepareGameArgs> api2wire_box_autoadd_prepare_game_args(PrepareGameArgs raw) {
...
late final OpaqueTypeFinalizer _PathBufFinalizer = OpaqueTypeFinalizer(inner._drop_opaque_PathBufPtr);
...
void _api_fill_to_wire_box_autoadd_prepare_game_args(PrepareGameArgs apiObj, ffi.Pointer<wire_PrepareGameArgs> wireObj) {
                _api_fill_to_wire_prepare_game_args(apiObj, wireObj.ref);
            }

void _api_fill_to_wire_box_autoadd_ui_layout(UILayout apiObj, ffi.Pointer<wire_UILayout> wireObj) {
                _api_fill_to_wire_ui_layout(apiObj, wireObj.ref);
            }



void _api_fill_to_wire_game_options(GameOptions apiObj, wire_GameOptions wireObj) {
...
void _api_fill_to_wire_jvm_options(JvmOptions apiObj, wire_JvmOptions wireObj) {
...
void _api_fill_to_wire_launch_args(LaunchArgs apiObj, wire_LaunchArgs wireObj) {
...
void _api_fill_to_wire_prepare_game_args(PrepareGameArgs apiObj, wire_PrepareGameArgs wireObj) {
...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_get_logger(
    int port_,
  ) {
    return _wire_get_logger(
      port_,
    );
  }

  late final _wire_get_loggerPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_get_logger');
  late final _wire_get_logger =
      _wire_get_loggerPtr.asFunction<void Function(int)>();
