...
fn wire_Collection_verify_and_download_game_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    that: impl CstDecode<
        RustOpaqueNom<flutter_rust_bridge::for_generated::rust_async::RwLock<Collection>>,
    >,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::DcoCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "Collection_verify_and_download_game",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_dco((move || async move {
                        let api_that = api_that.rust_auto_opaque_decode_ref();
 crate::api::shared_resources::collection::Collection::verify_and_download_game(&api_that).await
                    })().await)
            }
        },
    )
...
fn wire_set_ui_layout_storage_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    value: impl CstDecode<crate::api::backend_exclusive::storage::global_settings::UILayoutValue>,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
...
impl CstDecode<crate::api::backend_exclusive::storage::global_settings::UILayoutKey> for i32 {
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(self) -> crate::api::backend_exclusive::storage::global_settings::UILayoutKey {
        match self {
            0 => crate::api::backend_exclusive::storage::global_settings::UILayoutKey::CompletedSetup,
1 => crate::api::backend_exclusive::storage::global_settings::UILayoutKey::ShowsRecommendation,
2 => crate::api::backend_exclusive::storage::global_settings::UILayoutKey::SidebarPreivew,
...
impl SseDecode for Vec<Collection> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut len_ = <i32>::sse_decode(deserializer);
        let mut ans_ = vec![];
        for idx_ in 0..len_ {
            ans_.push(<Collection>::sse_decode(deserializer));
        }
        return ans_;
    }
}
...
impl SseDecode for crate::api::backend_exclusive::storage::global_settings::UILayoutKey {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut inner = <i32>::sse_decode(deserializer);
        return match inner {
...
impl SseDecode for crate::api::backend_exclusive::storage::global_settings::UILayoutValue {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut tag_ = <i32>::sse_decode(deserializer);
        match tag_ {
            0 => {
                ...
                return crate::api::backend_exclusive::storage::global_settings::UILayoutValue::CompletedSetup(var_field0);
            }
            1 => {
                let mut var_field0 = <bool>::sse_decode(deserializer);
                return crate::api::backend_exclusive::storage::global_settings::UILayoutValue::ShowsRecommendation(var_field0);
            }
            2 => {
                let mut var_field0 = <bool>::sse_decode(deserializer);
                return crate::api::backend_exclusive::storage::global_settings::UILayoutValue::SidebarPreivew(var_field0);
            }
            _ => {
                unimplemented!("");
            }
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart
    for crate::api::backend_exclusive::storage::global_settings::UILayoutKey
{
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {
            Self::CompletedSetup => 0.into_dart(),
            Self::ShowsRecommendation => 1.into_dart(),
            Self::SidebarPreivew => 2.into_dart(),
        }
    }
}
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
...
impl
    flutter_rust_bridge::IntoIntoDart<
        crate::api::backend_exclusive::storage::global_settings::UILayoutKey,
    > for crate::api::backend_exclusive::storage::global_settings::UILayoutKey
{
    fn into_into_dart(
        self,
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart
    for crate::api::backend_exclusive::storage::global_settings::UILayoutValue
{
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        match self {crate::api::backend_exclusive::storage::global_settings::UILayoutValue::CompletedSetup(field0) => { [0.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::api::backend_exclusive::storage::global_settings::UILayoutValue::ShowsRecommendation(field0) => { [1.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
crate::api::backend_exclusive::storage::global_settings::UILayoutValue::SidebarPreivew(field0) => { [2.into_dart(),
field0.into_into_dart().into_dart()].into_dart() }
 }
    }
}
...
impl
    flutter_rust_bridge::IntoIntoDart<
        crate::api::backend_exclusive::storage::global_settings::UILayoutValue,
    > for crate::api::backend_exclusive::storage::global_settings::UILayoutValue
{
    fn into_into_dart(
        self,
...
impl SseEncode for Vec<Collection> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(self.len() as _, serializer);
        for item in self {
            <Collection>::sse_encode(item, serializer);
        }
    }
}
...
impl SseEncode for crate::api::backend_exclusive::storage::global_settings::UILayoutKey {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(match self {crate::api::backend_exclusive::storage::global_settings::UILayoutKey::CompletedSetup => { 0 }
crate::api::backend_exclusive::storage::global_settings::UILayoutKey::ShowsRecommendation => { 1 }
crate::api::backend_exclusive::storage::global_settings::UILayoutKey::SidebarPreivew => { 2 }
 _ => { unimplemented!(""); }}, serializer);
    }
}

impl SseEncode for crate::api::backend_exclusive::storage::global_settings::UILayoutValue {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        match self {crate::api::backend_exclusive::storage::global_settings::UILayoutValue::CompletedSetup(field0) => { <i32>::sse_encode(0, serializer); <bool>::sse_encode(field0, serializer);
 }
crate::api::backend_exclusive::storage::global_settings::UILayoutValue::ShowsRecommendation(field0) => { <i32>::sse_encode(1, serializer); <bool>::sse_encode(field0, serializer);
 }
crate::api::backend_exclusive::storage::global_settings::UILayoutValue::SidebarPreivew(field0) => { <i32>::sse_encode(2, serializer); <bool>::sse_encode(field0, serializer);
 }
 }
    }
}
