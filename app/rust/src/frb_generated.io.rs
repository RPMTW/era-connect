...
impl CstDecode<Vec<crate::api::backend_exclusive::storage::storage_loader::StorageLoader>>
    for *mut wire_cst_list_storage_loader
{
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(
        self,
...
impl CstDecode<crate::api::backend_exclusive::storage::storage_loader::StorageLoader>
    for wire_cst_storage_loader
{
    // Codec=Cst (C-struct based), see doc to use other codecs
    fn cst_decode(self) -> crate::api::backend_exclusive::storage::storage_loader::StorageLoader {
...
impl NewWithNullPtr for wire_cst_storage_loader {
    fn new_with_null_ptr() -> Self {
        Self {
...
impl Default for wire_cst_storage_loader {
    fn default() -> Self {
        Self::new_with_null_ptr()
    }
}
...
#[no_mangle]
pub extern "C" fn frbgen_era_connect_cst_new_list_storage_loader(
    len: i32,
) -> *mut wire_cst_list_storage_loader {
    let wrap = wire_cst_list_storage_loader {
        ptr: flutter_rust_bridge::for_generated::new_leak_vec_ptr(
            <wire_cst_storage_loader>::new_with_null_ptr(),
            len,
        ),
        len,
    };
...
#[repr(C)]
#[derive(Clone, Copy)]
pub struct wire_cst_list_storage_loader {
    ptr: *mut wire_cst_storage_loader,
    len: i32,
}
#[repr(C)]
#[derive(Clone, Copy)]
...
#[repr(C)]
#[derive(Clone, Copy)]
pub struct wire_cst_storage_loader {
